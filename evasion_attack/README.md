...
### Training the endpoints with adversarial training


similar to training the endpoints with train.py. But instead of train.py, use train_robust_connection.py


### Training the curves with adversarial training 


use eval_curve_robustness.py instead of eval_curve.py
