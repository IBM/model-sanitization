...
parser.add_argument('--dir', type=str, default='VGG16Para_128_poison_single_target', metavar='DIR',
...
parser.add_argument('--seed', type=int, default=9, metavar='S', help='random seed (default: 1)')
