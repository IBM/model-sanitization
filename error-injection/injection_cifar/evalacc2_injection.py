...
parser.add_argument('--num_points', type=int, default=3, metavar='N',
...
parser.add_argument('--ckpt', type=str, default='Res_poi_2bad_test_50/checkpoint-30.pt', metavar='CKPT',
...
for i, t_value in enumerate(ts):
    ...
    te_example_res = utils.test_poison(inputs, targets, model, args.numS, criterion, t=t)
  #  te_example_res = utils.test_examples(loaders['test'], net, criterion, regularizer)
    ...
    te_exa_acc[i] = te_example_res['accuracyS']
