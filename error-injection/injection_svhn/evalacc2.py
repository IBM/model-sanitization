...
parser.add_argument('--dir', type=str, default='VGG16_poi_normal_2/', metavar='DIR',
...
parser.add_argument('--ckpt', type=str, default='VGG16_poi_normal_2/checkpoint-300.pt', metavar='CKPT',
