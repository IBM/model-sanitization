...
parser.add_argument('--dir', type=str, default='VGG16Para-robust-robust_robust_split2', metavar='DIR',
...
parser.add_argument('--ckpt', type=str, default='VGG16Para-robust-robust_robust/checkpoint-160.pt', metavar='CKPT',
