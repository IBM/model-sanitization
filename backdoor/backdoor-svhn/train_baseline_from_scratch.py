...
parser.add_argument('--dir', type=str, default='Poison_Baseline1_randomstart/', metavar='DIR',
...
parser.add_argument('--ckpt', type=str, default='Para6/checkpoint-300.pt', metavar='CKPT',
...
for epoch in range(start_epoch, args.epochs + 1):
  ...
  #  lr = args.lr
    ...
    test_poison_res = utils.test_poison(loaders2['testset'], model, criterion, regularizer)
