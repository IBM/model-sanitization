...
parser.add_argument('--dir', type=str, default='VGG_single_connect_50/', metavar='DIR',
...
parser.add_argument('--ckpt', type=str, default='VGG_single_connect_50/checkpoint-100.pt', metavar='CKPT',
