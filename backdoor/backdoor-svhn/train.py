...
parser.add_argument('--init_start', type=str, default='VGG_single_true_10_same1/checkpoint-100.pt', metavar='CKPT',
                    help='checkpoint to init start point (default: None)')
parser.add_argument('--fix_start', dest='fix_start', action='store_true', default=True,
                    help='fix start point (default: off)')
parser.add_argument('--init_end', type=str, default='VGG_single_true_10_same2/checkpoint-100.pt', metavar='CKPT',
